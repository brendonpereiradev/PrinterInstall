...
| Domain login | Authenticates against Active Directory (UPN or NetBIOS) over LDAP. |
...
1. **Login.** Sign in with your domain account as `user@domain` or `DOMAIN\user`. Credentials are not stored after you close the program.
